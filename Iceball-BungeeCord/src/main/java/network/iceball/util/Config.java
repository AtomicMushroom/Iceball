...
public class Config {
    ...
    public Properties getDatabaseConfiguration(){
        ...
        prop.setProperty("dataSource.url", "jdbc:mysql://" + (String) properties.get("server") + ":" + (String) properties.get("port") + "/?user=" + user + "&password=" + password);
